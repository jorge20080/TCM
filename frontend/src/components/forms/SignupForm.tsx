        ...
        <div className="min-h-screen grid bg-gray-50">
            <form action={signUpAction} className="shadow-2xl px-10 py-12 md:w-[450px] md:m-auto bg-white">
                ...
                <div className="md:flex gap-4 justify-between w-full">
                    <TextBox defaultValue={state.givenName} label="Given Name" name="givenName" type="text" placeholder="John" />
                    <TextBox defaultValue={state.lastName} label="Last Name" name="lastName" type="text" placeholder="Doe" />
                </div>
                <div className="md:flex gap-4 justify-between w-full">
                ...
                <div className="md:flex gap-4 justify-between w-full">
                    ...
                    <TextBox defaultValue={state.confirmPassword} label="Confirm Password" name="confirmPassword" type="password" placeholder="Pass123" />
                </div>
